...
Feature: CMV_配置查询
  ...
  @Smoke @cleanAll @deleteTagDir
  Scenario: 配置查询-搜索-下载
    When 创建名称为测试配置查询的CiClass目录

    When 在"测试配置查询"目录下,创建名称为"@啊啊啊啊and啊啊啊啊啊啊123啊_啊天啊啊啊啊啊啊啊啊啊_"的ci分类,使用图标为"Default"
    When 在"测试配置查询"目录下,创建名称为"&啊啊啊啊where啊啊啊啊ABC啊啊啊啊啊啊啊啊啊啊啊啊啊@"的ci分类,使用图标为"Default"
    When 在"测试配置查询"目录下,创建名称为"_啊啊啊啊or啊啊啊啊啊啊啊呵呵呵啊啊人啊啊啊啊啊啊啊啊啊&"的ci分类,使用图标为"Default"

	Then 用以下参数进行授权Auth:
  	|ciClassNames|roleName|dataType|see|edit|delete|add|
  	|@啊啊啊啊and啊啊啊啊啊啊123啊_啊天啊啊啊啊啊啊啊啊啊_|admin|2|true|true|true|true|
  	|&啊啊啊啊where啊啊啊啊ABC啊啊啊啊啊啊啊啊啊啊啊啊啊@|admin|2|true|true|true|true|
  	|_啊啊啊啊or啊啊啊啊啊啊啊呵呵呵啊啊人啊啊啊啊啊啊啊啊啊&|admin|2|true|true|true|true|
    ...
    When 创建名称为"testConfigureQuery"的标签目录
    When 在名称为"testConfigureQuery"的标签目录下,创建名称为"%！~#￥%……&*（）—+&"的标签
    When 在名称为"testConfigureQuery"的标签目录下,创建名称为"&！~#￥;1=1*（）—+@"的标签
    When 在名称为"testConfigureQuery"的标签目录下,创建名称为";select 1 ;"的标签
    ...
    And 用以下关键字进行下载:
      | commons | ciNames                         | tagNames        | words |
